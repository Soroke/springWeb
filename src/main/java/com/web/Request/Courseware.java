...
public class Courseware {
    ...
    private void imagetextParam() {
        ...
        //课件图片
        param.put("vo.bean.resourseUrl",images[(int)(Math.random()*14)]);
    ...
    private void imageParam() {
        ...
        //课件图片
        param.put("imgeAndDisc[0].resourceUrl",images[(int)(Math.random()*14)]);
        param.put("imgeAndDisc[1].resourceUrl",images[(int)(Math.random()*14)]);
        param.put("imgeAndDisc[2].resourceUrl",images[(int)(Math.random()*14)]);
        param.put("imgeAndDisc[3].resourceUrl",images[(int)(Math.random()*14)]);
        param.put("imgeAndDisc[4].resourceUrl",images[(int)(Math.random()*14)]);
        param.put("imgeAndDisc[5].resourceUrl",images[(int)(Math.random()*14)]);
